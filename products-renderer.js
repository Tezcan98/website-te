...
function renderProductList() {
  ...
  return '<!DOCTYPE html><html lang="tr"><head>'
    ...
    + '.card-img { background:var(--grad); height:180px; display:flex; align-items:center; justify-content:center; position:relative; }\n'
    + '.card-emoji { font-size:4.5rem; filter:drop-shadow(0 4px 12px rgba(0,0,0,.2)); }\n'
...
function renderProductDetail(productId) {
  ...
  return '<!DOCTYPE html><html lang="tr"><head>'
    ...
    + '.detail-visual { background:var(--grad); border-radius:24px; height:320px; display:flex; align-items:center; justify-content:center; position:relative; }\n'
    + '.detail-emoji { font-size:7rem; filter:drop-shadow(0 8px 20px rgba(0,0,0,.25)); }\n'
    ...
    + '.rel-img { font-size:3rem; margin-bottom:.75rem; }\n'
